...
whole_dataset = pd.read_csv('aligned_labeled_data.csv', header= None)
whole_dataset = whole_dataset.rename(index=str, columns={ 0: "text", 1: "aspect_category", 2: "sentiment", 3: "predicted_AS"})
whole_dataset = whole_dataset.drop(["predicted_AS"], axis=1)

# https://thispointer.com/python-pandas-how-to-drop-rows-in-dataframe-by-conditions-on-column-values/
indeces_none = whole_dataset[whole_dataset['aspect_category'] == 'NONE'].index
whole_dataset.drop(indeces_none, inplace=True)
