...
with open('train_test_data.csv', mode='w') as csv_file:
    ...
    fieldnames = ["network neutral", "net neutral", "pay prioritization", "throttle traffic", "support net neutral", "practice net neutral", "support network neutral", "practice network neutral", "be net neutral", "be network neutral"]
    
    # new fieldnames: combine net/network fields
    # add what is training and what is test
    # add whether that provider is net neutral or not
    # look for throttling
    # paid prioritization
    # could be easily applied to censorship...


    # could score by page... gradation or the percentage of pages that say it is/isn't net neutral
